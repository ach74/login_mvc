...
<div class="navbar navbar-default navbar-static-top" role="navigation">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo $home_url; ?>index.php/admin/index.php">Site Admin</a>
		</div>
		...
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				...
				<li <?php echo $page_title=="Admin Index" ? "class='active'" : ""; ?>>
					<a href="<?php echo $home_url; ?>index.php/admin/index.php">Home</a>
				</li>
				...
				? "class='active'" : ""; ?> >
				<a href="<?php echo $home_url; ?>index.php/admin/read_users.php">Users</a>
			</li>
		</ul>
		...
		<ul class="nav navbar-nav pull-right">
			<li class="dropdown">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="<?php echo $home_url; ?>index.php/home/logOut.php">Logout</a></li>
				</ul>
			</li>
		</ul>
