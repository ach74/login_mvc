...
class User extends CI_Model{
	...
	function emailExists(){
		...
		$query = "SELECT id, firstname, lastname, access_level, password, status FROM " . $this->table_name . " WHERE email = '".$this->email."' LIMIT 0,1";
		...
		if($num>0){
			...
			$this->access_level = $row[0]['access_level'];
	...
	function readOne(){
		...
		$query = "SELECT firstname, lastname, email, contact_number, address, access_level, password, status
		FROM " . $this->table_name . "
		WHERE id = ?
		LIMIT 0,1";
	...
	function readAll($from_record_num, $records_per_page){
		...
		$query = "SELECT id, firstname, lastname, email, contact_number, access_level, created FROM " . $this->table_name . " ORDER BY id DESC LIMIT $from_record_num, $records_per_page";
